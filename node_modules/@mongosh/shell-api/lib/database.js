    ...
    async createCollection(name, options = {}) {
        ...
        try {
            ...
            if (options.encryptedFields &&
                ['InvalidOptions', 'Location40415', 'TypeMismatch'].includes(err === null || err === void 0 ? void 0 : err.codeName) &&
                ((_a = err === null || err === void 0 ? void 0 : err.message) === null || _a === void 0 ? void 0 : _a.match(/\bclusteredIndex\b/))) {
                await this._improveErrorMessageForLowServerVersionForQE(err);
            }
            throw err;
        }
    }
    async _improveErrorMessageForLowServerVersionForQE(err) {
        try {
